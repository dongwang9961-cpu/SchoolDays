...
import com.schooldays.jooq.generated.tables.Roles.RolesPath;
...
public class UserRoles extends TableImpl<UserRolesRecord> {
     ...
     */
    public final TableField<UserRolesRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("gen_random_uuid()"), SQLDataType.UUID)), this, "");

    /**
     * The column <code>public.user_roles.seq_id</code>.
     */
    public final TableField<UserRolesRecord, Long> SEQ_ID = createField(DSL.name("seq_id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");
    ...
    /**
     * The column <code>public.user_roles.tenant_id</code>.
     */
    public final TableField<UserRolesRecord, UUID> TENANT_ID = createField(DSL.name("tenant_id"), SQLDataType.UUID, this, "");

    /**
     * The column <code>public.user_roles.metadata</code>.
     */
    public final TableField<UserRolesRecord, JSONB> METADATA = createField(DSL.name("metadata"), SQLDataType.JSONB.nullable(false).defaultValue(DSL.field(DSL.raw("'{}'::jsonb"), SQLDataType.JSONB)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_USER_ROLES_TENANT_SEQ, Indexes.IDX_USER_ROLES_USER);
    }
    ...
    public List<UniqueKey<UserRolesRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UQ_USER_ROLES_SCOPE, Keys.USER_ROLES_SEQ_ID_KEY);
    }

    @Override
    public List<ForeignKey<UserRolesRecord, ?>> getReferences() {
        return Arrays.asList(Keys.USER_ROLES__USER_ROLES_ROLE_ID_FKEY, Keys.USER_ROLES__USER_ROLES_TENANT_ID_FKEY, Keys.USER_ROLES__USER_ROLES_USER_ID_FKEY);
    }
    ...
    public TenantsPath tenants() {
        if (_tenants == null)
            _tenants = new TenantsPath(this, Keys.USER_ROLES__USER_ROLES_TENANT_ID_FKEY, null);
