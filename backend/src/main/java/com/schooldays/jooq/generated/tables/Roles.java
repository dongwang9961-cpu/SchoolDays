...
public class Roles extends TableImpl<RolesRecord> {
     ...
     */
    public final TableField<RolesRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(80).nullable(false), this, "");
    ...
    public List<UniqueKey<RolesRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UQ_ROLES_NAME);
    }
